...
func TestHeaderDeserializer(t *testing.T) {
	...
	fmt.Printf("%x\n", blkHdr.Hash.String())
	if !bytes.Equal(blkHdr.Hash[:], []byte{0x73, 0x07, 0x97, 0x74, 0x17, 0xea, 0x9f, 0x17, 0x90, 0xc8, 0x03, 0x88, 0x64, 0x8e, 0xd8, 0x16, 0x26, 0x50, 0xbe, 0x04, 0x45, 0x2b, 0x6b, 0x1d, 0xe8, 0xff, 0x9a, 0xd4, 0x2b, 0x36, 0x45, 0x23}) {

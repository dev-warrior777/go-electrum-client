...
type walletMustManager interface {
	...
	// involving them.
	AddWatchedAddresses(addrs ...btcutil.Address) error
...
type walletMustBanker interface {
	...
	Spend(amount big.Int, addr btcutil.Address, feeLevel FeeLevel, referenceID string, spendAll bool) (*chainhash.Hash, error)
